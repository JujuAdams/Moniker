...
function __MonikerParseDevanagari(_inString)
{
    static _matraLookupMap = __MonikerGlyphData().devanagariMatraMap;
    static _lookupMap      = __MonikerGlyphData().devanagariLookupMap;
    
    var _charArray = __MonikerDecompose(_inString);
    ...
    return __MonikerRecompose(_charArray);
}