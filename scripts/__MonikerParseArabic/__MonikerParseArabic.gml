...
function __MonikerParseArabic(_string)
{
    static _joinPrevMap = __MonikerGlyphData().arabicJoinPrevMap;
    static _joinNextMap = __MonikerGlyphData().arabicJoinNextMap;
    static _initialMap  = __MonikerGlyphData().arabicInitialMap;
    static _medialMap   = __MonikerGlyphData().arabicMedialMap;
    static _finalMap    = __MonikerGlyphData().arabicFinalMap;
    static _isolatedMap = __MonikerGlyphData().arabicIsolatedMap;
    ...
    __MonikerGlyphArrayBiDiReorder(_outGlyphArray, true, false);
    
    return __MonikerRecompose(_outGlyphArray, false);
}