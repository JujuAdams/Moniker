...
function __MonikerParseThai(_string)
{
    static _baseMap          = __MonikerGlyphData().thaiBaseMap;
    static _baseDescenderMap = __MonikerGlyphData().thaiBaseDescenderMap;
    static _baseAscenderMap  = __MonikerGlyphData().thaiBaseAscenderMap;
    static _topMap           = __MonikerGlyphData().thaiTopMap;
    static _lowerMap         = __MonikerGlyphData().thaiLowerMap;
    static _upperMap         = __MonikerGlyphData().thaiUpperMap;
    ...
    return __MonikerRecompose(_outArray, false);
}